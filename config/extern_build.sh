...
echo $METIS_DIR
echo $HYPRE_DIR
echo $SUITESPARSE_DIR

export LD_LIBARARY_PATH=${METIS_DIR}/lib:$LD_LIBRARY_PATH
export LD_LIBARARY_PATH=${HYPRE_DIR}/lib:$LD_LIBRARY_PATH
export LD_LIBARARY_PATH=${SUITESPARSE_DIR}/lib:$LD_LIBRARY_PATH
