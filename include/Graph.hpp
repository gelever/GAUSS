...
struct OldGraph
{
    ...
    */
    OldGraph(MPI_Comm comm, const SparseMatrix& vertex_edge_global,
    ...
    */
    OldGraph(SparseMatrix vertex_edge_local, ParMatrix edge_true_edge,
          std::vector<int> part_local,
          std::vector<double> weight_local = {},
          SparseMatrix W_block_local = {});

    /** @brief Default Destructor */
    ~OldGraph() noexcept = default;

    /** @brief Copy Constructor */
    OldGraph(const OldGraph& other) noexcept;

    /** @brief Move Constructor */
    OldGraph(OldGraph&& other) noexcept;

    /** @brief Assignment Operator */
    OldGraph& operator=(OldGraph other) noexcept;

    /** @brief Swap two graphs */
    friend void swap(OldGraph& lhs, OldGraph& rhs) noexcept;
...
//template <typename T>
//T GetVertexVector(const OldGraph& graph, const T& global_vect)
//{
//    return GetSubVector(global_vect, graph.vertex_map_);
//}
//
//template <typename T>
//void WriteVertexVector(const OldGraph& graph, const T& vect, const std::string& filename)
//{
...
//
//inline
//Vector ReadVertexVector(const OldGraph& graph, const std::string& filename)
//{
//    return ReadVector(filename, graph.vertex_map_);
//}
//
//inline
//BlockVector ReadVertexBlockVector(const OldGraph& graph, const std::string& filename)
//{
